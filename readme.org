...
#+NAME: thumbs
| U_NP  | U_NP  | ESC   | SPC   | TAB   | ENT   | BSPC  | MINS  | U_NP  | U_NP  |
...
| U_NP     | U_NP      | U_MEDIA     | U_NAV      | U_MOUSE | U_NUM   | U_SYM      | U_FUN       | U_NP      | U_NP     |
...
| RALT(KC_SCLN) | RALT(KC_LBRC) | RALT(KC_LCBR)  | RALT(KC_RBRC)  | RALT(KC_RCBR) |
